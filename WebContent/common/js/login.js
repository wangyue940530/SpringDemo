...
function(a, b) {
    function c(a) {
        function b(a, b) {
            var c;
            return window.getComputedStyle ? c = window.getComputedStyle(a, null).getPropertyValue(b) : a.currentStyle && (c = a.currentStyle[b]),
            c
        }
    ...
    function e() {
        ...
        var c = [];
        return f(document.images,
        function(a) { / \blazy\b / .test(a.className) && c.push(a)
        }),
        c
    }
    function f(a, b) {
...
!function() {
    ...
    if (b) {
        ...
        if ((c || "true" !== b.getItem("hideAppPromotionBar")) && (a.className += " is-AppPromotionBarVisible"), "#showWechatShareTip" === location.hash && "true" !== b.getItem("hideWechatShareTip")) try {
            a.className += " show-wechat-share-tip",
            b.setItem("hideWechatShareTip", "true")
        } catch(d) {}
    }
} (this)
...
function(a, b, c) {
    ...
    function e() {
        ...
        for (var i in s) if (s.hasOwnProperty(i)) {
            ...
            h = g.split("."),
            1 === h.length ? u[h[0]] = e: (!u[h[0]] || u[h[0]] instanceof Boolean || (u[h[0]] = new Boolean(u[h[0]])), u[h[0]][h[1]] = e),
            v.push((e ? "": "no-") + h.join("-"))
        }
    }
    function f(a) {
    ...
    function i() {
        var a = b.body;
        return a || (a = h(x ? "svg": "body"), a.fake = !0),
        a
    }
    function j(a, c, d, e) {
        ...
        m = h("div"),
        n = i();
        if (parseInt(d, 10)) for (; d--;) j = h("div"),
        j.id = e ? e[d] : l + (d + 1),
        m.appendChild(j);
        return f = h("style"),
        f.type = "text/css",
        ...
        m.id = l,
        n.fake && (n.style.background = "", n.style.overflow = "hidden", k = w.style.overflow, w.style.overflow = "hidden", w.appendChild(n)),
        g = c(m, a),
        n.fake ? (n.parentNode.removeChild(n), w.style.overflow = k, w.offsetHeight) : m.parentNode.removeChild(m),
        !!g
    }
    function k(a) {
    ...
    function l(b, d) {
        ...
        if ("CSSSupportsRule" in a) {
            ...
            return f = f.join(" or "),
            j("@supports (" + f + ") { #modernizr { position: absolute; } }",
            function(a) {
    ...
    function n(a, b, e, f) {
        ...
        for (var k, n, o, p, q, r = ["modernizr", "tspan"]; ! D.style;) k = !0,
        D.modElem = h(r.shift()),
        D.style = D.modElem.style;
        for (o = a.length, n = 0; o > n; n++) if (p = a[n], q = D.style[p], g(p, "-") && (p = m(p)), D.style[p] !== c) {
            if (f || d(e, "undefined")) return i(),
            "pfx" == b ? p: !0;
            try {
                D.style[p] = e
            } catch(s) {}
            if (D.style[p] != q) return i(),
            "pfx" == b ? p: !0
        }
        return i(),
        !1
