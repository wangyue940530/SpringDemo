...
<link type="text/css" rel="stylesheet" href="common/css/zhihu.css">
...
<meta id="znonce" name="znonce" content="1da911d4d75248ee86714f4f8df77324">
<!--[if lt IE 9]>
...
<input type="hidden" name="_xsrf" value="dc34a3aacf3c127c23bb5cbd72723407"/>
...
<form class="zu-side-login-box" action="login.spring" id="sign-form-1" autocomplete="off" method="POST">
...
<input required type="text" name="username" aria-label="姓名" placeholder="姓名">
</div>
...
<script type="text/json" class="json-inline" data-name="ga_vars">{"user_created":0,"now":1487835218000,"abtest_mask":"------------------------------","user_attr":[0,0,0,"-","-"],"user_hash":0}</script>

<script src="https://static.zhihu.com/static/revved/-/js/vendor.cb14a042.js"></script>
<script src="https://static.zhihu.com/static/revved/-/js/closure/base.b300f444.js"></script>

<script src="https://static.zhihu.com/static/revved/-/js/closure/common.fba9b17a.js"></script>
<script src="https://static.zhihu.com/static/revved/-/js/closure/page-index.8871e065.js"></script>
